...
def downgrade() -> None:
    ...
    op.create_foreign_key('items_collection_id_fkey', 'items', 'collections', ['collection_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key('images_collection_id_fkey', 'images', 'collections', ['collection_id'], ['id'], ondelete='CASCADE')
